<?php
/*
Plugin Name: Foot Score
Description: Saisissez les résultats de votre équipe et visualisez son classement
Version: 0.1
License: GPL
...
{
    add_menu_page(
        'Foot Score', // Titre de ma page
        'Foot Score', // titre du menu qui va s'afficher
